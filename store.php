...
<div class="x">
    ...
    <div class="shead">
        ...
        <div class="name">
            <h1><?php echo $this_store['sname']; ?><i class="Icon Icon--verified Icon--small <?php if($this_store['show'] != 1) {echo 'no';} ?>Certified"></i></h1>
        </div>
        <div class="b">
...
<div class="mian">
    ...
    <div class="show">
        ...
        <ul class="m">
            ...
            <a<?php if($index == 'comment') {echo ' class="on"';} ?> href="/store.<?php echo $this_store['id']; ?>.html?i=comment">动态<span><?php $say = $store->getSay($mysql); if(is_array($say)) {if(count($say) <= 99) {echo count($say);}else{echo '99+';}}else{echo 0;} ?></span></a>
            <a<?php if($index == 'photo') {echo ' class="on"';} ?> href="/store.<?php echo $this_store['id']; ?>.html?i=photo">照片<span><?php $photo = $store->getPhoto($mysql);  if(is_array($photo)) {if(count($photo) <= 99) {echo count($photo);}else{echo '99+';}}else{echo 0;} ?></span></a>
            <a<?php if($index == 'goods') {echo ' class="on"';} ?> href="/store.<?php echo $this_store['id']; ?>.html?i=goods">产品<span><?php $goods = $store->getGoods($mysql);  if(is_array($goods)) {if(count($goods) <= 99) {echo count($goods);}else{echo '99+';}}else{echo 0;} ?></span></a>
            <br class="clear" />
        </ul>
        <?php
