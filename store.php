...
<div class="mian">
    ...
    <div class="show">
        ...
        ?>
        <ul class="m">
            <a class="first<?php if($index == 'index') {echo ' on';} ?>" href="/<?php echo $this_store['id']; ?>">简介</a>
            <a<?php if($index == 'comment') {echo ' class="on"';} ?> href="?i=comment">动态<span><?php $say = $store->getSay($mysql); if(is_array($say)) {if(count($say) <= 99) {echo count($say);}else{echo '99+';}}else{echo 0;} ?></span></a>
            <a<?php if($index == 'photo') {echo ' class="on"';} ?> href="?i=photo">照片<span><?php $photo = $store->getPhoto($mysql);  if(is_array($photo)) {if(count($photo) <= 99) {echo count($photo);}else{echo '99+';}}else{echo 0;} ?></span></a>
            <a<?php if($index == 'goods') {echo ' class="on"';} ?> href="?i=goods">产品<span><?php $goods = $store->getGoods($mysql);  if(is_array($goods)) {if(count($goods) <= 99) {echo count($goods);}else{echo '99+';}}else{echo 0;} ?></span></a>
            <br class="clear" />
        </ul>
        <?php
