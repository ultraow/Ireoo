...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        UEDITOR_HOME_URL : URL// ＋ 'app/ueditor/'
        //图片上传配置区
       ...
       //,imageFieldName:"upfile"                   //图片数据的key,若此处修改，需要在后台对应文件修改对应参数
        ...
        ,toolbars: [["fontfamily","fontsize","bold","italic","underline","strikethrough","forecolor","backcolor"],["justifyleft","justifycenter","justifyright","inserttable","deletetable","formatmatch","removeformat","autotypeset","customstyle"]]
        //,toolbars:[["emotion","insertimage","map"]]
        //["bold","italic","underline","highlightcode","link","source"]
    ...
    ,themePath:URL +"themes/"
        ...
        ,initialFrameWidth:988  //初始化编辑器宽度,默认1000
