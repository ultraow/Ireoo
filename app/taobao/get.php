...
if(!isset($_REQUEST['id']) or $_REQUEST['id'] == '') die('{"error", "id不存在！"}');

$req->setNumIid($_REQUEST['id']);
$taobao = $c->execute($req);
die($taobao);
print_r(json_decode($taobao, true));
//echo $taobao;